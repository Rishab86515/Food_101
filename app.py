...
It is based upom a pre-trained Image Classification Model that comes with Keras and then retrained on the **Food101 Dataset**.
...
st.write("To know more about this app, visit [**GitHub**](https://github.com/Rishab86515/Food_vision)")
file = st.file_uploader(label="Upload an image of food.",
                        type=["jpg", "jpeg", "png"])


model = tf.keras.models.load_model("EfficientNetB1.hdf5")
